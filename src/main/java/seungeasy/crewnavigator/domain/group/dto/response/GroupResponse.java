 ...
 * Description: 그룹 조회 결과를 클라이언트에게 반환하기 위한 Response DTO.
 *
 * History
 * 2026.08.02: Seung-Geon: 스텁 DTO를 그룹 도메인 확장에 맞춰 구현
 * 2026.08.02: Seung-Geon: MyBatis 전환(CQRS)에 맞춰 팩토리를 GroupRow 기반으로 변경
 * </pre>
 *
 ...
 * @param createdAt   그룹 생성 일시
 * @param updatedAt   그룹 수정 일시
...
public record GroupResponse(
    ...
    /**
     * GroupRow를 GroupResponse DTO로 변환하는 정적 팩토리 메서드입니다.
     ...
     * @return 변환이 완료된 GroupResponse DTO
     */
    public static GroupResponse from(GroupRow row, List<String> tags) {
